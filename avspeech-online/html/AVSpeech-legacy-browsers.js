...
var incongV_list;
var aud_list_orig;
var incongV_list_orig;
var practice;
var practiceVisList;
var practiceAudList;
var practiceCondList;
var corrAnsList;
var corrAnsIdx;
var pract_idx;
var stim_idx;
...
var trialsAudList;
var trialsVisList;
var trialsConditionList;
var non_missed_trials;
var rt;
var practicePromptClock;
var blackScreen;
var doPracticePrompt;
var doPracticeResp;
var practiceInstructionClock;
var polygon;
var practInstr;
var practInstResp;
var BlankScreenClock;
var BlackBlank;
var practiceDisplayClock;
var sound_stim_pract;
var noise_pract;
var practiceResponseClock;
var blackRectP;
var PracticeRespOptions;
var PracticeResponse;
var practiceCorrectFeedbackClock;
var blackRectCorr;
var practiceCorr;
var practiceIncorrectFeedbackClock;
var blackRectIncorr;
var text_incorrect;
var practiceNoAnsFeedbackClock;
var rectNoAns;
var practNoAnsText;
var increment_pract_idxClock;
var instructionsClock;
var blackScreen2;
var text;
var key_resp;
var stimDisplayClock;
var sound_stim;
var noise_stim;
var stimResponseClock;
var BlackRectStim;
var StimRespOpts;
var StimResponseKey;
var rt_adjustClock;
var Inc_stim_idxClock;
var globalClock;
var routineTimer;
...
var _doPracticeResp_allKeys;
var practicePromptComponents;
function practicePromptRoutineBegin(trials) {
  return function () {
    ...
    practicePromptComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
var _practInstResp_allKeys;
var practiceInstructionComponents;
function practiceInstructionRoutineBegin(trials) {
  return function () {
    ...
    practiceInstructionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function practIncorrectLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  practIncorrect.forEach(function() {
...
var movieFile;
var soundFile;
var movie_stim_practClock;
var movie_stim_pract;
var practiceDisplayComponents;
function practiceDisplayRoutineBegin(trials) {
  return function () {
    ...
    practiceDisplayComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
var practiceCorrectFeedbackComponents;
function practiceCorrectFeedbackRoutineBegin(trials) {
  return function () {
    ...
    practiceCorrectFeedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
var practiceIncorrectFeedbackComponents;
function practiceIncorrectFeedbackRoutineBegin(trials) {
  return function () {
    ...
    practiceIncorrectFeedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
var practiceNoAnsFeedbackComponents;
function practiceNoAnsFeedbackRoutineBegin(trials) {
  return function () {
    ...
    practiceNoAnsFeedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
var increment_pract_idxComponents;
function increment_pract_idxRoutineBegin(trials) {
  return function () {
    ...
    increment_pract_idxComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function stimDisplayRoutineBegin(trials) {
  return function () {
    ...
    */
    ...
    stimDisplayComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
var _StimResponseKey_allKeys;
var stimResponseComponents;
function stimResponseRoutineBegin(trials) {
  return function () {
    ...
    stimResponseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function rt_adjustRoutineBegin(trials) {
  return function () {
    ...
    rt_adjustComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function Inc_stim_idxRoutineBegin(trials) {
  return function () {
    ...
    Inc_stim_idxComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
