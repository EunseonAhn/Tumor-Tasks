...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/BrangLab/Desktop/Pavlovia Experiments/avspeech-offline-arduino/AVSpeech_lastrun.py',
    ...
    for thisPracticeTrial in practiceTrials:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if PracticeResponse.status == STARTED and not waitOnFlip:
                theseKeys = PracticeResponse.getKeys(keyList=['e', 'd', 'c', 'b'], waitRelease=False)
