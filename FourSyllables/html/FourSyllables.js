...
let expName = 'FourSyllables';  // from the Builder filename that created this script
...
function experimentInit() {
  ...
  instruction = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruction',
    text: 'In this task, we will present you with a single word. As soon as you hear the word, please repeat it out loud. For example, if you hear the word "Boat", say "Boat". Please try to respond as fast as you can without making mistakes.\n\n\n',
    font: 'Arial',
    units: undefined, 
